...
5. Produce structured feedback at the end of the interview.
...
The following resources are provided for the challenge:
...
To ensure a fair competition, every submission goes through a **four-stage evaluation process**.

Automated verification is completed before judging so that judges only review valid submissions.
...
Only submissions that successfully complete **Stages 1 and 2** are evaluated by the judges.
...
1. Join a live video call.
2. Share their screen throughout the challenge.
3. Receive the same previously unseen feature request.
4. Implement the feature within **20 minutes** using their own repository.
5. Use any AI tools they used during the hackathon.
